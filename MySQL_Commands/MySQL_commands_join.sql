...
--title , rating, reviewer
 use tv_db;
 select title, rating, concat(first_name, ' ', last_name) as name from Reviews join Series on Series.id = Reviews.Series_id
 join Reviewers on Reviewers.id = Reviews.Reviewer_id order by rating;